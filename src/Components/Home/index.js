                ...
                <div style={{ backgroundColor: 'rgba(0,0,0,.7)' }}>
                    <div class="row site-hero-inner justify-content-center align-items-center m-0">
                        <div class="col-md-10 text-center">
                            ...
                            <p data-aos="fade-up" data-aos-delay="100"><a href="#" class="btn btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block pr-5 pl-5 ml-3" onClick={window.scrollTo(0, 700)}>لیست تورها</a> <a href="#" class="btn  btn-outline-light d-sm-inline d-block pr-5 pl-5">ایجاد تور جدید</a></p>
                        </div>
                    </div>
                </div>
            </section>
